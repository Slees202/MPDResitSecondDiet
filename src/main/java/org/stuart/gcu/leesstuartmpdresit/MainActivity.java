...
public class MainActivity extends AppCompatActivity implements OnClickListener
{
    ...
    public ArrayList handleOutput(String data){
    ...
    private class Task extends AsyncTask<String[], Void, ArrayList<Weather>> {
        ...
        public ArrayList<Weather> doInBackground(String[]... params) {
            ...
            return getParsedData(params[0][0]); }

        private ArrayList<Weather> getParsedData(String url)
        {
            URL url1;
            URLConnection yc;
            ...
            ArrayList<Weather> items= handleOutput(result);
